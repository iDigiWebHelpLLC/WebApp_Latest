...
class Applications extends StatefulWidget {
  String companyName, deviceName;
  final Subscriber subscriber;
  Applications(this.subscriber,this.companyName, this.deviceName);
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("CHOOSE APPLICATION",  style: theme.textTheme.headline6.copyWith(fontWeight: FontWeight.bold,color: CustomColours.samidarkRed),),
                        ),
                        Container(
                          //margin: EdgeInsets.only(left: 0.0,right: 0.0,top: 3),
                          alignment:Alignment.bottomCenter,
                        ...
                        StreamBuilder<QuerySnapshot>(
                          stream: Firestore.instance
                              .collection("Device Manual")
                              .document(widget.companyName)
                              .collection(widget.deviceName)
                              .getDocuments()
                              .asStream(),
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return ListTile(
                                      ...
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => Application(widget.subscriber,lstData[index].data)));
                                      },
                                    );
                                  }),
                            );
      ...
      child: Row(
        ...
        children: [
          ...
          Align(
            ...
            child:  Text('Applications',style: theme.textTheme.bodyText2.copyWith(color: CustomColours.grayDark),),
          ),
